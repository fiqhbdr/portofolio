    ...
    <section id="about" className="relative py-32 lg:py-48 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          <div className="reveal-left tilt-container lg:max-w-sm xl:max-w-md mx-auto lg:mx-0">
            <div className="tilt-inner relative group img-zoom" style={{ transformStyle: "preserve-3d" }}>
